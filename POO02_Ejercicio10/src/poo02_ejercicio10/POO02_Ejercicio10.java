...
package poo02_ejercicio10;
import java.util.Scanner;

public class POO02_Ejercicio10 {
    ...
    public static void main(String[] args) {
       ...
       if(patrimonio > 2000000 && estrato >3){
        ...
        System.out.println("El estudiante con numero de inscripcion "+num_inscripcion+" y nombre "+nombre+" debe de pagar "+pago_matricula);
